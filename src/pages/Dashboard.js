...
export default function Dashboard() {
  ...
  const { logout, isAuthenticated, user, authenticate } = useMoralis();
  if (!isAuthenticated) {
    return (
      <div className="text-white pt-80 items-center content-center text-center desc">
        Please{" "}
        <a
